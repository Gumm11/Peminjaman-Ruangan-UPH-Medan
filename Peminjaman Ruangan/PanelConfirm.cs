...
{
    public partial class PanelConfirm : UserControl
    {
        public PanelConfirm()
        {
            InitializeComponent();
        ...
        private void BtnConfirm_Click(object sender, EventArgs e)
        {
            ...
            while (parentControl != null && !(parentControl is PanelConfirm))
            {
                parentControl = parentControl.Parent;
            }

            if (parentControl is PanelConfirm)
            {
                // Now you can cast it safely
                PanelConfirm clickedForm = (PanelConfirm)parentControl;

                frmConfirm test = new frmConfirm();
